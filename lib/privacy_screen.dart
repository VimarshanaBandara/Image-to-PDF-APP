...
class _PrivacyHomeState extends State<PrivacyHome> {
  ...
  Widget build(BuildContext context) {
    ...
    Text('VM Mobile built the Image to PDF Converter/Free app as a Free app. This SERVICE is provided by VM Mobile at no cost and is intended for use as is.\n\nThis page is used to inform visitors regarding my policies with the collection, use, and disclosure of Personal Information if anyone decided to use my Service.If you choose to use my Service, then you agree to the collection and use of information in relation to this policy. The Personal Information that I collect is used for providing and improving the Service. I will not use or share your information with anyone except as described in this Privacy Policy.\n\nThe terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, which is accessible at Image to PDF Converter/Free unless otherwise defined in this Privacy Policy.',style: TextStyle(fontSize: 18.0),),
    SizedBox(height: 10.0,),
    ...
    SizedBox(height: 10.0,),
    Text('I may update our Privacy Policy from time to time. Thus, you are advised to review this page periodically for any changes. I will notify you of any changes by posting the new Privacy Policy on this page.This policy is effective as of 2021-04-05',style: TextStyle(fontSize: 18.0),),
    SizedBox(height: 10.0,),
    ...
    color: Colors.blue,
    onPressed: () { launch('https://docs.google.com/document/d/1AMkxUQgbodYt-Ofe5U5rZTB7ZhqmLcyYpwZHlRu5vu4/edit?usp=sharing');},
    )
